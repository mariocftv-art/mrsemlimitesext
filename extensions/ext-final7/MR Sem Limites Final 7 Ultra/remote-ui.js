...
// === BLACK & GOLD FIX: Reorganizar layout do chat via DOM direto ===
...
(function fixChatLayout() {
  function applyFix() {
    ...
    if (inputParent.contains(enhanceBtn)) {
      ...
      let enhanceRow = document.getElementById('mrf7u-enhance-row');
      if (!enhanceRow) {
        enhanceRow = document.createElement('div');
        enhanceRow.id = 'mrf7u-enhance-row';
    ...
    console.log('[BLACK & GOLD] Chat layout fix aplicado');
    return true;
  }
