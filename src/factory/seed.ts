...
export const SEED_EXTENSIONS: ExtensionRecord[] = [
  ...
  },
  {
    ...
    code: "EXT5",
    name: "MR Sem Limites v17.0.0",
    description: "Reconstrução Master Kit v17: Motor de Alta Performance integrado com backend oficial MR Sem Limites.",
    version: "17.0.0",
    status: "production",
    tone: "cyan",
    sourceDir: "extensions/ext-05/integrated/LV-CORE-REPLACEMENT-v17.0",
    packagedZip: "ext5_v1700_zip",
    assets: {},
    manifest: {
      manifestVersion: 3,
    ...
    versions: [
      {
        version: "17.0.0",
        releasedAt: "2026-08-07",
        notes: "Substituição completa pela base v17.0.0 enviada pelo usuário.",
        changes: ["Novo motor v17.0.0", "Backend MR Sem Limites sincronizado", "Suporte a Sidepanel", "Branding atualizado"],
      },
    ],
    notes: "Nova base v17.0.0 Master Kit.",
    createdAt: "2026-08-07",
    updatedAt: "2026-08-07",
  },
];
