...
export const SEED_EXTENSIONS: ExtensionRecord[] = [
  ...
  },
  {
    ...
    code: "EXT5",
    name: "MR Sem Limites v17.2.9",
    description: "Reconstrução Master Kit v17.2.5: Motor Infinito v17.0 (MR Engine) integrado com backend oficial MR Sem Limites.",
    version: "17.2.9",
    status: "production",
    tone: "cyan",
    sourceDir: "extensions/ext-05/integrated/LV-CORE-REPLACEMENT-v17.0",
    packagedZip: "ext5_v1729_zip",
    assets: {},
    manifest: {
      manifestVersion: 3,
    ...
    versions: [
      {
        ...
        changes: ["Build ID BUILD-17.2.9-Q7Y8R9N1", "Manifest v17.2.9 (Motor Infinito)", "Nova versão sincronizada"],
      },
    ],
