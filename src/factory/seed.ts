...
export const SEED_EXTENSIONS: ExtensionRecord[] = [
  ...
  },
  {
    ...
    code: "EXT5",
    name: "MR Sem Limites v17.9.0",
    description: "Reconstrução Master Kit v17.9.0: Motor de Alta Performance (Castler Core) integrado com backend oficial MR Sem Limites.",
    version: "17.9.0",
    status: "production",
    tone: "cyan",
    sourceDir: "extensions/ext-05/integrated/LV-CORE-REPLACEMENT-v17.0",
    packagedZip: "ext5_v1790_zip",
    assets: {},
    manifest: {
      manifestVersion: 3,
    ...
    versions: [
      {
        ...
        notes: "Atualização crítica de versão solicitada pelo usuário (v17.9.0).",
