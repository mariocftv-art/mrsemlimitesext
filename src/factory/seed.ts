...
export const SEED_EXTENSIONS: ExtensionRecord[] = [
  ...
  },
  {
    ...
    packagedZip: "/__l5e/assets-v1/878a542f-5ca0-4b9e-abbe-5cc7e9935401/MR_Sem_Limites_EXT3_v24.zip",
    assets: {},
    manifest: {
      manifestVersion: 3,
      permissions: ["storage", "sidePanel", "scripting", "activeTab"],
