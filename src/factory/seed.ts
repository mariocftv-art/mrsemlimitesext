...
export const SEED_EXTENSIONS: ExtensionRecord[] = [
  ...
  },
  {
    ...
    code: "EXT5",
    name: "MR Sem Limites v17.5.8",
    description: "Reconstrução Master Kit v17.5.8: Motor Infinito v17.0 (Desofuscado) integrado com Novo Backend Neon MR Sem Limites.",
    version: "17.5.8",
    status: "production",
    tone: "cyan",
    ...
    versions: [
      {
        ...
        changes: ["Versão 17.5.8 ativada", "Branding MR Sem Limites consolidado", "Backend Master Kit v3 totalmente integrado", "Formato de chave dual MR-XXXX"],
      },
    ],
