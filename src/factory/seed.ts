...
export const SEED_EXTENSIONS: ExtensionRecord[] = [
  ...
  },
  {
    ...
    code: "EXT5",
    name: "MR Sem Limites v17.2.5",
    description: "Reconstrução Master Kit v17.2.5: Motor de Alta Performance (Castler Core) integrado com backend oficial MR Sem Limites.",
    version: "17.2.5",
    status: "production",
    tone: "cyan",
    sourceDir: "extensions/ext-05/integrated/LV-CORE-REPLACEMENT-v17.0",
    packagedZip: "ext5_v1725_zip",
    assets: {},
    manifest: {
      manifestVersion: 3,
    ...
    versions: [
      {
        ...
        changes: ["Build ID BUILD-17.2.5-X9R2L5P1", "Manifest v17.2.5", "Nova versão sincronizada"],
      },
    ],
