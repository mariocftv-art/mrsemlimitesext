                ...
                <div className="p-6 text-center space-y-4">
                   ...
                   <div className="pt-4 grid grid-cols-2 gap-2 text-[10px]">
                      <div className="p-2 bg-white/5 rounded border border-white/10">
                         ...
                         <p className="text-emerald-400 font-bold">V17.0 Stable</p>
                      </div>
                      <div className="p-2 bg-white/5 rounded border border-white/10">
             ...
             <div className="space-y-4">
                <div className="flex items-center gap-2 mb-6">
                   ...
                   <div>
                      ...
                      <p className="text-[10px] text-muted-foreground">v17.0.0 (Production Build)</p>
                   </div>
                </div>
        ...
        <TabsContent value="background" className="flex-1 overflow-hidden m-0">
          <ScrollArea className="h-full">
            <div className="p-4 font-mono text-[10px] space-y-1 text-emerald-400">
               ...
               <p>[{new Date().toLocaleTimeString()}] SW: Initializing version 17.0.0...</p>
