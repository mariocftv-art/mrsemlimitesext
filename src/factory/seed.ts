...
export const SEED_EXTENSIONS: ExtensionRecord[] = [
  ...
  },
  {
    ...
    code: "EXT5",
    name: "MR Sem Limites v17.0.1",
    description: "Reconstrução Master Kit v17.0.1: Motor de Alta Performance (Castler Core) integrado com backend oficial MR Sem Limites.",
    version: "17.0.1",
    status: "production",
    tone: "cyan",
    sourceDir: "extensions/ext-05/integrated/LV-CORE-REPLACEMENT-v17.0",
    packagedZip: "ext5_v1701_zip",
    assets: {},
    manifest: {
      manifestVersion: 3,
    ...
    versions: [
      {
        version: "17.0.1",
        releasedAt: "2026-08-07",
        notes: "Atualização de segurança e sincronização de bypass v17.0.1.",
        changes: ["Bypass de licença MT39A reforçado", "HWID sync v2", "Remoção de logs legados"],
      },
    ],
    notes: "Nova base v17.0.1 Master Kit — Motor Castler V3.",
    createdAt: "2026-08-07",
    updatedAt: "2026-08-07",
  },
];
