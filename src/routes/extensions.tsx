...
import ext1ZipAsset from "@/assets/ext1_v27_zip.asset.json";
import ext2ZipAsset from "@/assets/ext2_v27_zip.asset.json";
import ext3ZipAsset from "@/assets/ext3_v27_zip.asset.json";
          ...
          <Card className="glass border-primary/40">
            <CardContent className="flex items-center justify-between p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-bold">EXTENSÃO UM 2.7</p>
          ...
          <Card className="glass border-violet-500/40">
            <CardContent className="flex items-center justify-between p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-bold">EXTENSÃO DOIS 2.7</p>
          ...
          <Card className="glass border-magenta-500/40">
            <CardContent className="flex items-center justify-between p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-bold">EXTENSÃO TRÊS 2.7</p>
