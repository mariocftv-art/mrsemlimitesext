...
(function(){
  var IAS = [
    {group:'auto', id:'auto',      emoji:'✨', title:'AUTO — Melhor para o comando', score:10, power:'A extensão detecta se o pedido é texto, imagem, vídeo ou voz e escolhe SEMPRE o melhor modelo disponível.', tag:'INTELIGENTE', directive:'MODO AUTO: analise o pedido do usuário e escolha SEMPRE o melhor modelo disponível para a tarefa — GPT-5 / Claude Opus 4 para código pesado, Claude Sonnet 4.5 para código sério, Gemini 2.5 Pro para contexto grande, Nano Banana / GPT-Image para imagem premium, Veo 3 para vídeo com áudio e ElevenLabs para voz humana premium. Use as contas/credenciais do usuário; não use créditos de IA do workspace.'},
    ...
    {group:'text', id:'gemflash',  emoji:'💨', title:'Gemini 2.5 Flash',       score:6,  power:'Rápido, respostas do dia-a-dia, usando a IA escolhida/conta do usuário. ⭐',          tag:'PADRÃO',           directive:'Use o modelo Gemini 2.5 Flash (nível 6) pela conta do usuário. Rápido e barato.'},
    ...
    {group:'tts',  id:'eleven',    emoji:'🎙️', title:'ElevenLabs (voz humana premium)', score:10, power:'Voz humana ultra-realista PT-BR, entonação natural, ideal para locução profissional e Reels.', tag:'VOZ PREMIUM', directive:'MODO VOZ: gere narração/locução com ElevenLabs (voz humana premium PT-BR) usando a conta do usuário. Máxima naturalidade, use para vídeos profissionais e Reels.'}
  ];
