...
const EXT5_ZIP_URL = "/__l5e/assets-v1/4f37991a-a6f0-4773-a0c1-bf33e73ec45f/MR-Sem-Limites-EXT5-v5.3.9.zip";
          ...
          <CardContent className="flex flex-col gap-3 p-4 md:flex-row md:items-center md:justify-between">
            ...
            <div className="flex flex-col gap-2 md:flex-row md:w-auto">
              <Button
                ...
                onClick={() => {
                  downloadZip(EXT5_ZIP_URL, "MR-Sem-Limites-EXT5-v5.3.9.zip");
                  toast.success("Download da EXT5 iniciado.");
                }}
              >
                <Download className="h-4 w-4" /> EXT5 v5.3.9 Download
              </Button>
              <Button variant="outline" className="gap-1.5 border-emerald-500/60 text-emerald-400 hover:bg-emerald-500/10 md:w-auto" onClick={openSupport}>
                <MessageCircle className="h-4 w-4" /> Suporte
              </Button>
