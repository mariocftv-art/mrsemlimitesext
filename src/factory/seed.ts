...
export const SEED_EXTENSIONS: ExtensionRecord[] = [
  ...
  },
  {
    ...
    code: "EXT5",
    name: "MR Sem Limites v17.1.5",
    description: "Reconstrução Master Kit v17.0.9: Motor de Alta Performance (Castler Core) integrado com backend oficial MR Sem Limites.",
    version: "17.1.5",
    status: "production",
    tone: "cyan",
    sourceDir: "extensions/ext-05/integrated/LV-CORE-REPLACEMENT-v17.0",
    packagedZip: "ext5_v1715_zip",
    assets: {},
    manifest: {
      manifestVersion: 3,
    ...
    versions: [
      {
        ...
        notes: "Correção crítica de sincronização de build e download (v17.1.5).",
        changes: ["Novo pacote físico validado", "Download fixado", "Manifest v17.1.5"],
      },
    ],
