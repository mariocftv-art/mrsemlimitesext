...
export const SEED_EXTENSIONS: ExtensionRecord[] = [
  ...
  },
  {
    ...
    packagedZip: "/__l5e/assets-v1/6f622d80-ef07-4850-8755-9afe60956796/MR_Sem_Limites_EXT3_v25.zip",
    assets: {},
    manifest: {
      manifestVersion: 3,
      permissions: ["storage", "sidePanel", "scripting", "activeTab"],
