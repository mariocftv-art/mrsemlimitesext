...
export const SEED_EXTENSIONS: ExtensionRecord[] = [
  ...
  },
  {
    ...
    description: "Reconstrução Master Kit v17.0.2: Motor de Alta Performance (Castler Core) integrado com backend oficial MR Sem Limites.",
    version: "17.0.2",
    status: "production",
    tone: "cyan",
    ...
    versions: [
      {
        version: "17.0.2",
        releasedAt: "2026-08-07",
        notes: "Atualização de segurança e sincronização de bypass v17.0.2.",
        changes: ["Bypass de licença MT39A reforçado", "HWID sync v2", "Remoção de logs legados"],
      },
    ],
    notes: "Nova base v17.0.2 Master Kit — Motor Castler V3.",
    createdAt: "2026-08-07",
    updatedAt: "2026-08-07",
  },
];
