...
export const SEED_EXTENSIONS: ExtensionRecord[] = [
  ...
  },
  {
    ...
    slug: "qyron-v7",
    code: "EXT5",
    name: "VOX QYRON v7.0.0",
    description: "Nova geração VOX QYRON com motor Castler V2 e bypass de créditos nativo.",
    version: "7.0.0",
    status: "production",
    tone: "orange",
    sourceDir: "extensions/ext-05/integrated/QYRON-V7",
    packagedZip: "ext5_v700_zip",
    assets: {},
    manifest: {
      manifestVersion: 3,
    ...
    versions: [
      {
        version: "7.0.0",
        releasedAt: "2026-08-07",
        notes: "Migração QYRON V7 com Backend MR Sem Limites.",
        changes: ["Novo motor Castler V2", "Bypass de créditos integrado", "Sessão desacoplada"],
      },
    ],
    notes: "QYRON V7 original com backend MR.",
    createdAt: "2026-08-07",
    updatedAt: "2026-08-07",
  },
];
